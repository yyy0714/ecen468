...
After simulation, click on the simulation output frame at the bottom of the window and press <kbd>Ctrl</kbd>-<kbd>X</kbd>, and <kbd>Ctrl</kbd>-<kbd>S</kbd> to save the simulation. Put “sim.out” as the filename and press <kbd>Enter</kbd> to save, as shown in Figure 10.
