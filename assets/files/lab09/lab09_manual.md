...
![Design Vision library setup under File -> Setup -> Defaults](img/7.png)
...
![Analyze dialog in Design Vision](img/8.png)
...
![Elaborate dialog in Design Vision](img/9.png)

Synthesize the module

Use **Design -> Compile Design**. And Click **OK**.

![Compile Design dialog in Design Vision](img/10.png)
