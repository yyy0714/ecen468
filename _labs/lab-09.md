...
![System Overview]({{ "/assets/files/lab09/img/system_overview.png" | relative_url }})
...
![SRAM Address Map]({{ "/assets/files/lab09/img/sram_addr_map.png" | relative_url }})

*Figure 3. SRAM Address Map*

![UART Transmitter Address Map]({{ "/assets/files/lab09/img/uart_tx_addr_map.png" | relative_url }})
